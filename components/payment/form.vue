      ...
      <form>
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" v-model="fullname" name="firstname" placeholder="John M. Doe">
            ...
            <input type="text" v-model="address" name="address" placeholder="542 W. 15th Street">
            ...
            <div class="row">
              <div class="col-50">
                ...
                <input type="text" v-model="state" name="state" placeholder="NY">
              </div>
              <div class="col-50">
                <label class="colorlabel" for="zip">Zip</label>
                <input type="text" v-model="zip" name="zip" placeholder="10001">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text" v-model="cname" name="cardname" placeholder="John More Doe">
            <label class="colorlabel" for="ccnum">Credit card number</label>
            <input type="text" v-model="ccnum" name="cardnumber" placeholder="1111-2222-3333-4444">
            <label class="colorlabel" for="expmonth">Exp Month</label>
            <input type="text" v-model="expmonth" name="expmonth" placeholder="September">
            <div class="row">
              <div class="col-50">
                <label class="colorlabel" for="expyear">Exp Year</label>
                <input type="text" v-model="expyear" name="expyear" placeholder="2018">
              </div>
              <div class="col-50">
                <label class="colorlabel" for="cvv">CVV</label>
                <input type="text" v-model="cvv" name="cvv" placeholder="352">
              </div>
            </div>
          </div>
        ...
        <button tyep="button" class="btn" @click="submit()"> Confirm Order</button>
      </form>
    </div>
  </div>
